    ...
    >
      <div className="container flex flex-col lg:flex-row gap-md pb-md">
        <div className="flex flex-col md:flex-row items-start gap-sm pt-xs max-w-full md:max-w-xl">
          <img src="/images/marty.png" alt="" width={52} height={70} className='hidden md:block mb-xs self-center md:self-start' />
          <div>
            <img src="/images/marty.png" alt="" width={52} height={70} className='md:hidden mb-xs self-center md:self-start' />
