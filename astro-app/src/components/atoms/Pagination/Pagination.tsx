  ...
  return (
    <div className={clsx('flex flex-row gap-sm items-center h-[22px]', className)} {...props} >
      <div className='cursor-pointer max-h-full h-full' onClick={() => {
        ...
        <img src={color === 'white' ? '/images/arrow-left.svg' : '/images/arrow-left-black.svg'} alt={t('pagination.left')} width={212} height={48} loading="lazy" className="relative left-0 object-contain max-h-full max-w-full" />
      </div>
      ...
      <div className='cursor-pointer max-h-full h-full' onClick={() => {
        ...
        <img src={color === 'white' ? '/images/arrow-right.svg' : '/images/arrow-right-black.svg'} alt={t('pagination.right')} width={212} height={48} loading="lazy" className="relative right-0 object-contain max-h-full max-w-full" />
      </div>
