...
const MemberCard: React.FC<MemberCardProps> = ({
  ...
  const Card = (
    <div
      ...
      {...props}
    >
      {image && <img src={image} alt="" className="block w-full h-full object-cover bg-blue" loading="lazy" width={240} height={315} />}
  ...
  return (
    linkedin
      ? (<a href={linkedin} className="block shadow-block shadow-block--building">
        {Card}
      </a>)
      : Card
  );
