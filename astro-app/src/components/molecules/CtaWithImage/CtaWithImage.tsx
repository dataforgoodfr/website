...
const CtaWithImage: React.FC<CtaWithImageProps> = ({
  ...
  return (
    ...
    >
      ...
      <img src={image} alt="" width={770} height={770} className={clsx("absolute -z-1 top-0 bottom-0 my-auto w-96 h-96 sm:w-[770px] sm:h-[770px] max-w-none", imageClassName, imagePosition === "left" ? "right-0" : "left-24")} />
    </div>
  );
};
