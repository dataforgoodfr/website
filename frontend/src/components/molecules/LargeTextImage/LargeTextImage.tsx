...
const LargeTextImage: React.FC<LargeTextImageProps> = ({
  ...
  const bgImageClass = background === "gray" ? 'bg-[url("/images/bg-highlight-gray.svg")]' : 'bg-[url("/images/bg-highlight-purple.svg")]';

  return (
    <div
      className={clsx(
        'overflow-hidden grid grid-cols-1 grid-rows-[200px_1fr] md:grid-rows-1 max-h-[850px]',
    ...
    >
      ...
      <div className="col-start-1 row-start-2 md:row-start-1">
        <div className="container h-full">
          <div className={clsx(
            'flex flex-col justify-center items-start max-w-xl ml-auto h-full bg-cover bg-center',
            bgImageClass,
          )}>
